...
../src/apt-compare-versions --left "9.0.7-1~bpo70" --right "9.0.7-1~bpo70+1"
echo "    Exit value : ${?}"

../src/apt-compare-versions -l "9.0.7-1" -r "9.0.7-1"
echo "    Exit value : ${?}"

../src/apt-compare-versions -l "9.0.7-1~bpo70+1" -r "9.0.7-1~bpo70"
echo "    Exit value : ${?}"
